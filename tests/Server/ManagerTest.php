...
use Lamen\Http\Websocket\Parser;
use Lamen\Http\Table\SwooleTable;
use Swoole\Http\Server as HttpServer;
use Illuminate\Support\Facades\Config;
use Lamen\Http\Websocket\Websocket;
use Lamen\Http\Websocket\HandlerContract;
use Lamen\Http\Websocket\Rooms\TableRoom;
use Lamen\Http\Websocket\Rooms\RoomContract;
use Illuminate\Contracts\Debug\ExceptionHandler;
use Lamen\Http\Websocket\SocketIO\SocketIOParser;
use Lamen\Http\Websocket\SocketIO\WebsocketHandler;
use Lamen\Http\Websocket\Facades\Websocket as WebsocketFacade;
...
class ManagerTest extends TestCase
{
    ...
    {
        parent::mockMethod($name, $function, 'Lamen\Http\Server');
    }
}
